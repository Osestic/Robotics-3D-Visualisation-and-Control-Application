function varargout = stlread_mod(file)
...
%    'faces' and 'vertices'.
%
%    [F,V] = stlread_mod(FILENAME) returns the faces F and vertices V separately.
%
%    [F,V,N] = stlread_mod(FILENAME) also returns the face normal vectors.
%
%    The faces and vertices are arranged in the format used by the PATCH plot
%    object.
%    modified to give correct V and F
